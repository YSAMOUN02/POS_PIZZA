...
!(function () {
    ...
    var T = R(
        ...
        b = new Set();
    (Object.keys(D[I]).map(b.add.bind(b)),
        Object.keys(D[L]).map(b.add.bind(b)));
    var V = []
            .concat(Y, l(b), [
                "2xs",
                "xs",
    ...
    var xt = ut.styles,
        At = ut.shims,
        Ot =
            (s((u = {}), I, Object.values(F[I])),
            s(u, L, Object.values(F[L])),
            u),
        Nt = null,
        Pt = {},
        St = {},
    ...
    function Ht(t, a) {
        ...
        return (
            (t.includes("fa-brands") || t.includes("fab")) &&
                (a.prefix = "fab"),
            (t.includes("fa-duotone") || t.includes("fad")) &&
                (a.prefix = "fad"),
            a.prefix ||
                o !== L ||
    ...
    function Vt(t) {
        ...
        if (a)
            return (
                (a = Yt(t, a) || a),
                vt(Gt.definitions, t, a) || vt(ut.styles, t, a)
            );
    }
    var Gt = new u(),
        Kt = {
            ...
            parse: {
                icon: function (t) {
                    ...
                    if (
                        "string" == typeof t &&
                        (-1 < t.indexOf("".concat(J.cssPrefix, "-")) ||
                            t.match(W))
                    ) {
                ...
                va ||
                    ...
                    et(t).forEach(function (t) {
                        ...
                        ("childList" === t.type &&
                            ...
                            !la(t.addedNodes[0]) &&
                            (J.searchPseudoElements && s(t.target),
                            r(t.target)),
                            "attributes" === t.type &&
                                t.target.parentNode &&
            ...
            (i.iconName && i.prefix) ||
                (i.prefix &&
                    ...
                    (i.iconName =
                        ((e = i.prefix),
                        (n = t.innerText),
                        (St[e] || {})[n] || Lt(i.prefix, yt(t.innerText)))),
                !i.iconName &&
                    J.autoFetchSvg &&
                    t.firstChild &&
    ...
    function Oa(t) {
        var a =
            "nest" === J.autoReplaceSvg ? xa(t, { styleParser: !1 }) : xa(t);
        ...
        return new Promise(function (e, t) {
            ...
            u && "none" !== d && "" !== d
                ? ((s = l.getPropertyValue("content")),
                  ...
                  !u ||
                  c ||
                  (f && f.getAttribute(S) === n && f.getAttribute(C) === i)
                      ? e()
                      : (b.setAttribute(v, i),
                        f && b.removeChild(f),
                        ((o = (r = {
